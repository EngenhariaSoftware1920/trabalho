...
class ClienteAnimalTest {
	...
	@Test
	void valuesTest() {
		Animal newA = new Animal(randomNome(), auxE, "Fêmea", LocalDate.of(2016, Month.APRIL, 4));
		ClienteAnimal aux = new ClienteAnimal(newA, c, LocalDate.of(2016, Month.APRIL, 4));
		assertFalse(a.insertClienteAnimal(aux));
		aux = new ClienteAnimal(a, c, LocalDate.of(2016, Month.APRIL, 4));
		assertTrue(a.insertClienteAnimal(aux));
	}
	@RepeatedTest(5)
	void insertTest() {
